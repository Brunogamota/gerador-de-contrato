  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <h2 className="text-lg font-semibold text-white mb-1">Pré-visualização da Proposta</h2>
      ...
      <div className="rounded-xl border border-white/[0.08] overflow-hidden">
        <div className="bg-white/[0.03] border-b border-white/[0.08] px-4 py-2 flex items-center gap-2">
          ...
          <span className="text-xs text-white/40 ml-2">Proposta #{proposalNumber}</span>
        </div>
