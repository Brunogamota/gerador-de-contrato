...
export function ContractDocument({ contractData: d, mdrMatrix, contractNumber }: ContractDocumentProps) {
  ...
  return (
    ...
    >
      ...
      <Clause title="CLÁUSULA VIGÉSIMA – DAS ALTERAÇÕES CONTRATUAIS">
        <Item n="20.1">A REBORN reserva-se o direito de modificar os termos e condições deste Contrato, mediante notificação ao CONTRATANTE com antecedência mínima de 30 (trinta) dias.</Item>
        <Item n="20.2">Caso o CONTRATANTE não concorde com as alterações, poderá rescindir o Contrato sem multa no prazo de 10 (dez) dias da notificação. A não manifestação implicará concordância tácita.</Item>
        <Item n="20.3">Quaisquer aditamentos que não sejam decorrentes do direito unilateral da REBORN previsto neste Contrato deverão ser celebrados por escrito e assinados por ambas as Partes.</Item>
      </Clause>

      <Clause title="CLÁUSULA VIGÉSIMA PRIMEIRA – DAS DECLARAÇÕES E GARANTIAS">
        <Item n="21.1">O CONTRATANTE declara e garante, neste ato e durante toda a vigência contratual, que: (i) está devidamente constituído e em regular funcionamento, com capacidade jurídica para celebrar e cumprir as obrigações deste Contrato; (ii) a celebração deste Contrato não viola qualquer disposição legal, regulatória ou contratual a que esteja sujeito; (iii) todas as informações e documentos fornecidos à REBORN são verdadeiros, completos e precisos; (iv) seus produtos e/ou serviços comercializados são lícitos e em conformidade com a legislação vigente; (v) possui todas as licenças, autorizações e registros necessários ao exercício de suas atividades.</Item>
        <Item n="21.2">A inexatidão, incompletude ou falsidade de qualquer das declarações acima constitui justa causa para rescisão imediata do Contrato, sem prejuízo das penalidades previstas neste instrumento e da responsabilização civil e criminal do CONTRATANTE.</Item>
      </Clause>

      <Clause title="CLÁUSULA VIGÉSIMA SEGUNDA – DOS SUBSELLERS E RESPONSABILIDADE NA REDE DE RECEBEDORES">
        <Item n="22.1">Para fins deste Contrato, entende-se por Subseller toda pessoa física ou jurídica cadastrada pelo CONTRATANTE na Plataforma REBORN como recebedor final de transações de cartão de crédito ou débito, por meio da funcionalidade de split de pagamentos.</Item>
        <Item n="22.2">O processamento de transações de cartão de crédito e débito na Plataforma REBORN é condicionado ao uso obrigatório do modelo de split de pagamentos. O CONTRATANTE não poderá processar transações de cartão em nome próprio para repasse posterior a terceiros sem o devido cadastro desses terceiros como subsellers na Plataforma REBORN.</Item>
        <Item n="22.3">O CONTRATANTE é o único e exclusivo responsável pelo cadastramento, habilitação, monitoramento e gestão de seus subsellers, sendo-lhe vedado cadastrar como subseller qualquer pessoa física ou jurídica que: (i) exerça atividades listadas na Cláusula Sétima deste Contrato; (ii) esteja irregular perante a Receita Federal, BACEN ou demais órgãos reguladores; (iii) figure em listas restritivas nacionais ou internacionais (COAF, OFAC, ONU, PEP); (iv) não possua documentação cadastral completa e válida exigida pela REBORN.</Item>
        <Item n="22.4">O CONTRATANTE reconhece e aceita expressamente que, ao fornecer infraestrutura tecnológica de pagamentos a seus subsellers, assume a posição de responsável solidário perante a REBORN, as bandeiras de cartão e as autoridades competentes pelos atos praticados por seus subsellers. Na hipótese de prática de ato ilícito, fraude, lavagem de dinheiro, operação irregular ou qualquer conduta vedada por subseller cadastrado pelo CONTRATANTE, este responderá como co-participante direto, por ter viabilizado e disponibilizado a infraestrutura necessária para a realização das operações.</Item>
        <Item n="22.5">A responsabilidade solidária do CONTRATANTE pelos atos de seus subsellers abrange, sem limitação: (i) todos os chargebacks e estornos gerados por transações de subsellers; (ii) multas e penalidades impostas pelas bandeiras de cartão; (iii) danos causados a consumidores finais, à REBORN ou a terceiros; (iv) sanções administrativas, fiscais ou penais decorrentes das operações dos subsellers; (v) qualquer valor retido, bloqueado ou penalizado pelas adquirentes em razão de irregularidades dos subsellers.</Item>
        <Item n="22.6">O CONTRATANTE obriga-se a celebrar com cada subseller instrumento contratual próprio contemplando, no mínimo: (i) identificação completa com CNPJ/CPF, endereço e beneficiários finais; (ii) declaração de conformidade legal e regulatória; (iii) autorização de compartilhamento de dados com a REBORN para KYC e PLD/FT; (iv) ciência das atividades proibidas da Cláusula Sétima; (v) obrigação de manutenção de documentação fiscal e contábil regular.</Item>
        <Item n="22.7">A REBORN poderá, a seu exclusivo critério e a qualquer tempo, exigir documentação completa de qualquer subseller, recusar o cadastro ou determinar o descadastramento imediato de subseller que apresente indícios de irregularidade, risco elevado ou incompatibilidade com suas políticas internas, sem que isso gere qualquer direito de indenização ao CONTRATANTE.</Item>
        <Item n="22.8">A fim de reduzir riscos operacionais, regulatórios e de fraude em sua rede de subsellers, a REBORN recomenda ao CONTRATANTE a adoção das seguintes boas práticas: (i) realizar due diligence prévia de cada subseller antes do cadastramento, incluindo consulta a cadastros de inadimplentes e certidões negativas; (ii) exigir e manter atualizada a documentação cadastral completa; (iii) monitorar regularmente o volume e padrão de transações, identificando anomalias e picos atípicos de chargebacks; (iv) estabelecer limite máximo de volume transacional por subseller compatível com o porte e atividade declarada; (v) implementar política interna de KYC para subsellers equivalente à exigida pela REBORN; (vi) verificar periodicamente se os subsellers continuam ativos e regulares; (vii) manter canal de comunicação direto com cada subseller para tratar prontamente disputas e solicitações regulatórias; (viii) não cadastrar como subseller entidades sem relação comercial clara e documentada; (ix) comunicar imediatamente à REBORN qualquer suspeita de uso irregular da infraestrutura; (x) revisar e atualizar os contratos com subsellers ao menos anualmente.</Item>
        <Item n="22.9">O descumprimento das obrigações previstas nesta Cláusula constitui justa causa para rescisão imediata do Contrato, além de sujeitar o CONTRATANTE às penalidades da Cláusula Oitava e à responsabilização integral por todos os danos causados.</Item>
      </Clause>

      <Clause title="CLÁUSULA VIGÉSIMA TERCEIRA – DA GARANTIA PESSOAL, FIANÇA E CONFISSÃO DE DÍVIDA">
        <Item n="23.1">Como condição para a celebração deste Contrato e para o acesso à Plataforma REBORN, os sócios e/ou administradores do CONTRATANTE identificados no Quadro-Resumo ou em instrumento apartado assinam o presente Contrato na qualidade de fiadores e principais pagadores, em caráter solidário e irrevogável, responsabilizando-se pessoalmente pelo cumprimento integral de todas as obrigações financeiras assumidas pelo CONTRATANTE perante a REBORN, incluindo principal, multas, juros, correção monetária e honorários advocatícios.</Item>
        <Item n="23.2">A fiança ora prestada: (i) é solidária, não se aplicando o benefício de ordem previsto no art. 827 do Código Civil; (ii) subsiste mesmo em caso de falência, liquidação, recuperação judicial ou extrajudicial do CONTRATANTE; (iii) alcança todas as obrigações presentes e futuras decorrentes deste Contrato e de seus aditamentos; (iv) permanece válida até a quitação integral de todos os débitos, mesmo após o término do Contrato.</Item>
        <Item n="23.3">O CONTRATANTE, por si e por seus sócios e administradores na qualidade de fiadores, desde já confessa e reconhece como dívida líquida, certa e exigível todos os valores que venham a ser apurados pela REBORN em decorrência deste Contrato, incluindo: (i) taxas e tarifas de processamento; (ii) valores de chargebacks e pré-chargebacks; (iii) multas contratuais; (iv) invoices emitidas e não pagas; (v) quaisquer prejuízos causados à REBORN. Esta confissão de dívida constitui título executivo extrajudicial nos termos do art. 784, III, do Código de Processo Civil, dispensando processo de conhecimento prévio.</Item>
        <Item n="23.4">Os sócios fiadores renunciam expressamente ao benefício de excussão prévia dos bens do CONTRATANTE, podendo a REBORN acionar direta e imediatamente o patrimônio pessoal dos fiadores independentemente de qualquer medida prévia contra o CONTRATANTE.</Item>
        <Item n="23.5">Os sócios fiadores declaram que os dados de qualificação completa (nome, CPF, RG, estado civil, endereço) serão preenchidos no campo de assinaturas ao final deste instrumento, integrando-o para todos os efeitos legais.</Item>
      </Clause>

      <Clause title="CLÁUSULA VIGÉSIMA QUARTA – DA CESSÃO FIDUCIÁRIA DE RECEBÍVEIS COMO GARANTIA">
        <Item n="24.1">O CONTRATANTE cede fiduciariamente à REBORN, em caráter irrevogável e irretratável durante toda a vigência contratual e até a quitação integral de eventuais débitos, o direito sobre os recebíveis gerados pelas transações processadas na Plataforma REBORN, como garantia real do cumprimento de todas as obrigações assumidas neste instrumento.</Item>
        <Item n="24.2">A cessão fiduciária confere à REBORN direito preferencial e privilegiado sobre os recebíveis do CONTRATANTE em relação a quaisquer outros credores, podendo a REBORN reter, compensar e apropriar os valores necessários à cobertura de débitos diretamente do fluxo de repasses, independentemente de notificação judicial ou extrajudicial.</Item>
        <Item n="24.3">Na hipótese de insuficiência dos recebíveis para cobertura dos débitos, a REBORN poderá acionar os demais instrumentos de garantia previstos neste Contrato, incluindo a fiança pessoal dos sócios e a execução da confissão de dívida.</Item>
      </Clause>

      <Clause title="CLÁUSULA VIGÉSIMA QUINTA – DO VENCIMENTO ANTECIPADO CRUZADO">
        <Item n="25.1">Todos os valores devidos pelo CONTRATANTE à REBORN, independentemente de prazo ou condição, tornar-se-ão imediatamente exigíveis, vencendo-se antecipadamente de pleno direito, nas seguintes hipóteses: (i) inadimplência do CONTRATANTE com qualquer credor financeiro, bancário ou operacional relevante; (ii) protesto de títulos contra o CONTRATANTE ou seus sócios em valor individual superior a R$ 10.000,00 (dez mil reais); (iii) execução judicial ou extrajudicial contra o CONTRATANTE em qualquer valor; (iv) pedido de recuperação judicial, extrajudicial ou autofalência; (v) alienação relevante de ativos ou encerramento das atividades sem quitação prévia dos débitos com a REBORN; (vi) alteração do controle societário sem notificação prévia à REBORN.</Item>
        <Item n="25.2">O vencimento antecipado opera de pleno direito, dispensando qualquer notificação, interpelação judicial ou extrajudicial, e autoriza a REBORN a adotar imediatamente todas as medidas de cobrança e garantia previstas neste Contrato.</Item>
      </Clause>

      <Clause title="CLÁUSULA VIGÉSIMA SEXTA – DA VEDAÇÃO À DIFAMAÇÃO E CONDUTA PÓS-CONTRATUAL">
        <Item n="26.1">O CONTRATANTE obriga-se a não praticar, direta ou indiretamente, por si ou por terceiros, qualquer ato de difamação, calúnia, injúria, denegação de crédito ou descrédito em face da REBORN, de seus sócios, administradores, colaboradores ou da Plataforma REBORN, incluindo, de forma exemplificativa e não exaustiva: (i) publicações em redes sociais (Instagram, Facebook, Twitter/X, LinkedIn, TikTok e similares); (ii) mensagens em grupos de WhatsApp, Telegram, Discord ou quaisquer aplicativos de mensagens, públicos ou privados; (iii) postagens em fóruns, comunidades online, plataformas de avaliação (Reclame Aqui, Google Reviews, Trustpilot e similares); (iv) comunicados a associações, entidades de classe, órgãos reguladores ou à imprensa; (v) declarações verbais em eventos, palestras, webinars ou reuniões profissionais; (vi) criação ou participação em grupos e comunidades cujo propósito seja depreciar ou difamar a REBORN.</Item>
        <Item n="26.2">É especialmente vedado ao CONTRATANTE, durante e após a vigência deste Contrato: (i) atribuir à REBORN responsabilidade por inadimplências, bloqueios, suspensões ou rescisões que decorram do próprio descumprimento contratual do CONTRATANTE; (ii) veicular informações falsas, distorcidas ou parciais sobre o funcionamento, as taxas, os serviços ou as práticas comerciais da REBORN; (iii) afirmar publicamente que foi prejudicado ou enganado pela REBORN quando o motivo do encerramento da relação contratual for conduta ilícita, irregular ou inadimplente do próprio CONTRATANTE; (iv) induzir terceiros a não contratar ou a rescindir contratos com a REBORN com base em informações falsas.</Item>
        <Item n="26.3">A prática de qualquer ato descrito nos itens 26.1 e 26.2 sujeitará o CONTRATANTE infrator ao pagamento de: (i) multa cominatória de R$ 30.000,00 (trinta mil reais) por evento identificado, entendendo-se como evento cada publicação, mensagem, declaração ou ato isolado de difamação; (ii) indenização integral por perdas e danos materiais e morais causados à REBORN, a ser apurada em liquidação de sentença; (iii) obrigação de remoção imediata do conteúdo difamatório no prazo de 24 (vinte e quatro) horas da notificação, sob pena de multa diária de R$ 5.000,00 (cinco mil reais) por dia de descumprimento. As multas são cumulativas entre si e com quaisquer outras penalidades contratuais.</Item>
        <Item n="26.4">A REBORN poderá, independentemente das multas contratuais, ingressar com medidas judiciais de urgência para obtenção de tutela inibitória, remoção de conteúdo e reparação de danos, incluindo ação de obrigação de fazer, ação indenizatória e representação criminal por calúnia, difamação e injúria nos termos dos arts. 138, 139 e 140 do Código Penal.</Item>
        <Item n="26.5">As obrigações previstas nesta Cláusula sobrevivem ao término ou rescisão deste Contrato por prazo de 5 (cinco) anos, sendo aplicáveis independentemente do motivo da extinção contratual.</Item>
        <Item n="26.6">O exercício legítimo do direito de reclamação perante órgãos de defesa do consumidor (PROCON, BACEN, etc.) ou o registro de ocorrência policial devidamente fundamentado não configuram infração a esta Cláusula, desde que o CONTRATANTE se abstenha de veicular informações inverídicas nesses canais.</Item>
      </Clause>

      <Clause title="CLÁUSULA VIGÉSIMA SÉTIMA – DAS DISPOSIÇÕES GERAIS E FINAIS">
        <Item n="27.1">Este Contrato, juntamente com seus Anexos, constitui o acordo integral entre as Partes, substituindo todos os entendimentos, negociações e acordos anteriores, verbais ou escritos, sobre o mesmo objeto.</Item>
        <Item n="27.2">Se qualquer disposição deste Contrato for considerada inválida, nula ou inexequível, as demais disposições permanecerão em pleno vigor e efeito (cláusula de severabilidade).</Item>
        <Item n="27.3">A tolerância de qualquer das Partes ao descumprimento de obrigação pela outra Parte não implica novação, renúncia ou alteração dos termos contratuais.</Item>
        <Item n="27.4">Este Contrato será regido e interpretado de acordo com as leis da República Federativa do Brasil.</Item>
        <Item n="27.5">As Partes elegem o foro da Comarca de {d.foro} como o único competente para dirimir quaisquer questões ou litígios oriundos deste Contrato, renunciando expressamente a qualquer outro, por mais privilegiado que seja.</Item>
        <Item n="27.6">Antes de recorrer ao Poder Judiciário, as Partes envidarão esforços de boa-fé para resolver amigavelmente eventuais controvérsias no prazo de 30 (trinta) dias, podendo, de comum acordo, eleger mediação ou arbitragem.</Item>
        <Item n="27.7">Este instrumento pode ser assinado eletronicamente, com validade jurídica nos termos da MP nº 2.200-2/2001 e da Lei nº 14.063/2020, sendo reconhecida como válida a assinatura digital por certificado ICP-Brasil ou por plataformas de assinatura eletrônica reconhecidas pelas Partes.</Item>
        <Item n="27.8">O presente Contrato está disponível para consulta a qualquer tempo pelas Partes. Eventuais dúvidas sobre interpretação de cláusulas deverão ser submetidas ao departamento jurídico da REBORN pelo e-mail juridico@rebornpay.io.</Item>
      </Clause>
