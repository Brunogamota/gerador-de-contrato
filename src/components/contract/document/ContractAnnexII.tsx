...
export function ContractAnnexII({ d, mdrMatrix }: Props) {
  ...
  return (
    <div style={{ fontFamily: sans, marginTop: '32px', paddingTop: '24px', borderTop: '2px solid #cbd5e1', pageBreakBefore: 'always' }}>

      <p style={{ fontFamily: sans, fontSize: '13pt', fontWeight: 700, textAlign: 'center', textTransform: 'uppercase', letterSpacing: '0.06em', color: '#0f172a', marginBottom: '28px' }}>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '24px' }}>
        <thead>
          ...
          <tr style={{ background: '#f8fafc' }}>
            <td style={{ fontFamily: sans, fontSize: '7.5pt', color: '#94a3b8', fontStyle: 'italic', padding: '5px 14px', border }}>
              Taxa Final (MDR)
            </td>
            {BRANDS.map((brand) => (
              <td key={brand} style={{ fontFamily: sans, fontSize: '7.5pt', color: '#94a3b8', fontStyle: 'italic', textAlign: 'center', padding: '5px 6px', border }}>
                Taxa Final
              </td>
            ))}
          </tr>
              ...
              <td style={{ padding: '11px 14px', border }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <span style={{
                    ...
                    borderRadius: '4px', padding: '2px 7px', fontSize: '8pt',
                    fontFamily: sans, fontWeight: 600, minWidth: '24px',
                    textAlign: 'center', flexShrink: 0,
                  }}>
                    {INST_NUM[inst as number]}×
                  </span>
                  <span style={{ fontFamily: sans, fontSize: '10.5pt', color: '#1e293b', fontWeight: i === 0 ? 600 : 400 }}>
                    {INST_LABELS[inst as number]}
                  </span>
                </div>
              </td>
              {BRANDS.map((brand) => (
                <td key={brand} style={{ textAlign: 'center', padding: '10px 6px', border, verticalAlign: 'middle' }}>
      ...
      {/* ── 3. Minimum monthly ── */}
      <p style={{ fontFamily: sans, fontSize: '11pt', fontWeight: 700, color: '#0f172a', marginBottom: '8px' }}>
